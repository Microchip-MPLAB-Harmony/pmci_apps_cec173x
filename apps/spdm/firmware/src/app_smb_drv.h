...
#ifndef _APP_SMB_DRV_H
#define _APP_SMB_DRV_H
...
typedef enum
{
    ...
    APP_SMB_DRV_STATE_INIT=0,
    APP_SMB_DRV_STATE_SERVICE_TASKS,
    APP_SMB_DRV_STATE_INIT_ERROR,
...
/*******************************************************************************
  ...
  Description:
    ...
    APP_SMB_DRV_Tasks function can be called.
